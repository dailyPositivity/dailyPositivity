...
let  activeClass =  [false,false,false,true,false];//to set active class for speed buttons on slideshow
      ...
      return(
         <div className = 'slideshowContainer'>
            ...
            <div className="slideSpeed">
               ...
               <button className = {`slideSpeedBtn ${activeClass[1] ? 'slideSpeedActiveBtn' : ''}`}  onClick = {(event) => {this.setActiveClass(event);this.speedHandler(event);}}  value='5000'  disabled={this.disableSpeedButton()}>5s</button>
               <button className = {`slideSpeedBtn ${activeClass[2] ? 'slideSpeedActiveBtn' : ''}`}  onClick = {(event) => {this.setActiveClass(event);this.speedHandler(event);}}  value='10000'  disabled={this.disableSpeedButton()}>10s</button>
               <button className = {`slideSpeedBtn ${activeClass[3] ? 'slideSpeedActiveBtn' : ''}`}  onClick = {(event) => {this.setActiveClass(event);this.speedHandler(event);}}  value='30000'  disabled={this.disableSpeedButton()}>30s</button>
